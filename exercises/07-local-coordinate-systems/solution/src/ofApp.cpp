...
void drawRibbon(float length, float half_width) {
    ofDrawTriangle(0.0f, -half_width, length, 0.0f, 0.0f, half_width);
}
void drawLocalSculpture(const sculpture::Design& design, const sculpture::Scene& scene,
    ...
    drawRibbon(design.first_length, 2.5f);
    {
        ...
        drawRibbon(design.second_length, 3.5f);
        ofNoFill();
        ofDrawRectangle(design.second_length - design.ornament_radius,
                        -design.ornament_radius,
                        design.ornament_radius * 2.0f,
                        design.ornament_radius * 2.0f);
        ofDrawLine(design.second_length - design.ornament_radius, 0.0f,
                   design.second_length + design.ornament_radius, 0.0f);
    }
}
}
void ofApp::setup() {
    ofSetWindowTitle("Section 07 solution: counterweighted ribbons");
