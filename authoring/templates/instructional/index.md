...
objectives:
  ...
  - Build one testable mechanism
  - Explain how code, mathematics, and image correspond
prerequisites:
  - Name the prior section or skill
...
![Describe the motion's meaningful start, change, and end state.](media/preview-motion.svg "Explain the timing or mapping the learner should notice.")

*Explain the timing or mapping the learner should notice.*

![Describe the meaningful geometry, spatial relationship, and state.](media/preview-still.svg "Explain what the learner should notice without motion.")
