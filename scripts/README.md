...
Sections 00–03 use thin platform wrappers around the shared, containment-checked
...
For sections 01–03, substitute the matching two-digit section number in those
