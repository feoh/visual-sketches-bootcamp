...
Sections 00–09 use thin platform wrappers around the shared, containment-checked
...
For sections 01–09, substitute the matching two-digit section number in those
