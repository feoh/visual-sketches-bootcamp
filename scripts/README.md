...
Sections 00–11 use thin platform wrappers around the shared, containment-checked
...
For sections 01–11, substitute the matching two-digit section number in those
