...
Sections 00–05 use thin platform wrappers around the shared, containment-checked
...
For sections 01–05, substitute the matching two-digit section number in those
