...
Sections 00–04 use thin platform wrappers around the shared, containment-checked
...
For sections 01–04, substitute the matching two-digit section number in those
