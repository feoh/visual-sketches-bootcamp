...
make_fixture(){ fixture=$1; mkdir -p "$fixture/scripts"; cp -R "$root/authoring" "$fixture/authoring"; cp "$root/scripts/check-authoring.sh" "$fixture/scripts/"; chmod +x "$fixture/scripts/check-authoring.sh"; }
